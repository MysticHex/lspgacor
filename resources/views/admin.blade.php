    ...
    <div class="row row-cols-3">
        ...
        <div class="col">
            <form action="" method="get">
                <div class="input-group">
                    <label class="input-group-text" for="inputGroupSelect01">Kategori</label>
                    <select name="sort" class="form-select" id="inputGroupSelect01" onchange="this.form.submit()">
                        <option selected disabled hidden>Kategori</option>
                            ...
                            <td class="w-25">
                                @if ($aspirasi->input_aspirasi->image)
                                    <div type="button" class="container" data-bs-toggle="modal"
                                        ...
                                        <img src="{{ asset('storage/' . $aspirasi->input_aspirasi->image) }}"
                                            class="img-flex w-50" alt="">
                                    </div>
