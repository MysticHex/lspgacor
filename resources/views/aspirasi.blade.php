                ...
                <div class="container">
                    <div class="row fs-4">
                        @foreach ($aspirasi as $aspirasi)
                            ...
                            <div class="col-9">
                                <img src="{{ asset('storage/' . $aspirasi->input_aspirasi->image) }}" class="img-fluid" alt="" width="40%">    
                            </div>
                                        ...
                                        <form action="aspirasi/feedback/{{ $aspirasi->id }}" method="post">
                                            ...
                                            <div class="container mx-auto">
                                                <div class="row mx-auto">
                                                    <div class="col">
                                                        <input type="radio" name="feedback" id="1" class="feedback"><label for="1">1</label>
                                                    </div>
                                                    <div class="col">
                                                        <input type="radio" name="feedback" id="2" class="feedback"><label for="2">2</label>
                                                    </div>
                                                    <div class="col">
                                                        <input type="radio" name="feedback" id="3" class="feedback"><label for="3">3</label>
                                                    </div>
                                                    <div class="col">
                                                        <input type="radio" name="feedback" id="4" class="feedback"><label for="4">4</label>
                                                    </div>
                                                    <div class="col">
                                                        <input type="radio" name="feedback" id="5" class="feedback"><label for="5">5</label>
                                                    </div>
                                                    </div>
                                                </div>
                                                <button type="submit"
                                                    class="btn btn-primary form-control mb-2">Submit</button>
                                        </form>
                                    </div>
                                @else
